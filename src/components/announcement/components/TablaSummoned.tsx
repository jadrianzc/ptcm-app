										...
										<>
											...
											<div className="flex flex-col text-sm justify-center">
												<span className="w-fit text-gray3 border-gray3 md:border-b">
													Recuerda que tienes 00:00 horas para bajarte de
													la convocatoria sin multa.
												</span>
												<span className="w-fit text-gray4 border-gray4 md:border-b">
													Se agotó el tiempo para bajarte de la
													convocatoria sin multa. A partir de este momento
