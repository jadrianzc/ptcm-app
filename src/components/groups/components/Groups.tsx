			...
			<div className="space-y-8 md:space-y-14">
				{now.isBefore(convocationDates?.callEndDate) ? (
					<div className="bg-white h-[250px] rounded-xl md:h-[353px]">
						<div className="h-full flex flex-col justify-center items-center gap-5 text-blue">
							<span className="text-xs font-semibold md:text-4xl">
				...
				) : now.isAfter(convocationDates?.callEndDate) &&
